...
RE.footer = document.getElementById('article_footer');
...
RE.addFooter = function(emailBody)
{
    $("#article_footer").show();
    RE.footer.innerHTML = emailBody;

    var height  =document.documentElement.offsetHeight;
    bodySizeChanged(height);
    if(emailBody.length > 0)
        $("#originalEmailLink").hide();
    
    document.getElementById("article_footer").scrollLeft=0;
    /*
     #div1
     */
//        document.getElementById("originalEmailLink").hide();
}
...
RE.Height = function()
{
    return document.getElementById("article_footer").Height;
}
